...
<?php include("assets-admin/includes/header-auditor.php");?>
...
<?php include("assets-admin/includes/side-menu-auditor.php");?>
...
<span class="title-home-link"><a href="auditor-dashboard.php">
