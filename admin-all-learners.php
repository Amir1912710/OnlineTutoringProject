...
<h1 class="title-page-name">All Learners</h1>
</div>
</div>
</div>
</div>
...
<td><a href="javascript:void(0)" class="btn-small-01 bg-01 my-1 d-block" data-bs-toggle="modal" data-bs-target="#ViewDetails" >View Details</a></td>
</tr>
...
if(!$conn){
    die("coonection failed: " . mysqli_connect_error());
  	...
  	$sql= "SELECT * FROM learnersignup WHERE RUMNUM = ViewDetails";
    $row= $conn->query($sql);
