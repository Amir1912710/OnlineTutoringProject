...
<div class="card">
<img src="assets-admin/img-Extra/rooms-img-01.jpg" class="img-fluid" alt=""/>
...
<div class="col-6">
<p><span class="fw-bold me-2">Type:</span>A12</p>
</div>
<div class="col-6">
<span class="fw-bold me-2">Price:</span>1222$</p>
</div>
</div>
<div class="d-grid">
<a href="javascript:void(0)" class="btn-lg-01 bg-03" data-bs-toggle="modal" data-bs-target="#CourseContent">Open Course</a>
</div>
</div>
</div>
</div>
...
<div class="text-center"><input class="rating" value="4"> <button type="submit" class="btn-small-01 bg-01 mt-2">Rate This</button></div>
</div>
</div>
</div>
</div>
