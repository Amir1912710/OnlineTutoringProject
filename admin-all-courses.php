...
if(isset($_POST['submit'])){ 
  ...
  $sql="insert into courses (CourseName , CourseType , CoursePrice , Image) values('".$_POST['formcoursename']."','".$_POST["formcoursetype"]."','".$_POST["formcourseprice"]."','".$target_file2."')";
...
if(isset($_POST['SubmitEdit'])){ 
	...
	$sql2="UPDATE courses SET CourseName= '".$_POST['formcoursenamee']."',CourseType= '".$_POST["formcoursetypee"]."',CoursePrice= '".$_POST["formcoursepricee"]."' WHERE CourseID='".$_POST['formcourseIdd']."'";
	$conn2->query($sql2);
  $conn2->close();
}
...
<td>
<a  id="course_details_action" href="javascript:void(0)" class="btn-small-01 bg-01 my-1 d-block" data-bs-toggle="modal" data-bs-target="#CourseDetails" data-id="<?php  echo  $row['CourseID'] ?>">View Course Details</a>
<a id="course_edit_action" href="javascript:void(0)" class="btn-small-01 bg-03 my-1 d-block" data-bs-toggle="modal" data-bs-target="#CourseEdit" data-id="<?php  echo  $row['CourseID'] ?>">Edit Course</a>
<a id="course_delete_action" href="" class="btn-small-01 bg-02 my-1 d-block" data-id="<?php  echo  $row['CourseID'] ?>">Delete Course</a>
</td>
</tr>
...
<label class="form-label active" for="formcoursenamee">Course Name</label>
</div>
</div>
<div class="col-lg-6 col-md-6">
<div class="form-outline mb-4">
...
<label class="form-label active" for="formcoursetypee">Course Type</label>
</div>
</div>
<div class="col-lg-6 col-md-6">
<div class="form-outline mb-4">
<input type="text" class="form-control" id="formcoursepricee" name="formcoursepricee" value="120 $" />
<label class="form-label active" for="formcoursepricee">Course Price</label>
</div>
</div>
<!-- <div class="col-lg-6 col-md-6">
<div class="form-outline mb-4">
...
var courseId=$(this).data('id');
   ...
   $.ajax({
      ...
      success: function (data) {
        ...
        $(".modal-body #formcoursenamee").val( obj[0].CourseName);
        $(".modal-body #formcoursetypee").val( obj[0].CourseType);
        $(".modal-body #formcoursepricee").val( obj[0].CoursePrice);
