...
<div class="col-lg-8">
<div class="d-grid">
<button type="submit" class="btn-lg-01 bg-01">Add Course</button>
</div>
</div>
</div>
</form>
...
<a href="javascript:void(0)" class="btn-small-01 bg-03 my-1 d-block" data-bs-toggle="modal" data-bs-target="#CourseEdit">Edit Course</a>
<a href="javascript:void(0)" class="btn-small-01 bg-02 my-1 d-block delete-request">Delete Course</a>
</td>
</tr>
