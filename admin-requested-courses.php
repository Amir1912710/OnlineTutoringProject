...
<td>
<a href="admin-requested-courses.php" id="Rcourse_approve_action" class="btn-small-01 bg-03 my-1 d-block"  data-id="<?php  echo  $row['CourseID'] ?>" data-name="<?php  echo  $row['CourseName'] ?>" data-type="<?php  echo  $row['CourseType'] ?>" data-price="<?php  echo  $row['Price'] ?>" data-image="<?php  echo  $row['Image'] ?>">Approve Course</a>
<a href="admin-requested-courses.php" class="btn-small-01 bg-02 my-1 d-block" id="Rcourse_delete_action" data-id="<?php  echo  $row['CourseID'] ?>">Reject Course</a>
</td>
</tr>
...
<script>
  ...
  var courseImage=$(this).data('image');
    $.ajax({
        ...
        data: {'approvecourseDetails':true,'RcourseId':courseId,'RcourseName':courseName,'RcourseType':courseType,'RcoursePrice':coursePrice,'RcourseImage':courseImage },
