...
<div class="col-lg-12">
<div class="d-grid">
<button name="submit" type="submit" class="btn-lg-01 bg-01">Edit &amp; Save</button>
</div>
</div>
</div>
</div>
...
<button href="javascript:void(0)" class="br-fa-white text-fa-white btn crop_image_ind">Edit &amp; Save</button>
</div>
</div>
</div>
</div>
