...
<!-- <h2 class="text-danger mb-3">15</h2> -->
<?php  echo "<h2 class='text-danger mb-3'>".countCourses()."</h2>"; ?>
<h4 class="text-danger">All Courses</h4>
</div>		
</div>
	
<div class="col-md-4 mb-4">
<div class="card px-3 py-4 text-center">
<?php  echo "<h2 class='text-success mb-3'>".countCart()."</h2>"; ?>
...
<div class="col-md-4 mb-4">
<div class="card px-3 py-4 text-center">
<?php  echo "<h2 class='text-warning mb-3'>".countMyCourses()."</h2>"; ?>
<h4 class="text-warning">My Courses</h4>
</div>	
</div>
