...
<div class="col-6">
<a id="get_rating_values" class="fw-bold me-2" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#CourseRate" data-id="<?php  echo  $row['CourseID'] ?>">
...
<div class="d-grid">
<a href="javascript:void(0)" id="add_course_tocart" class="btn-lg-01 bg-01 my-1 d-block"  data-id="<?php  echo  $row['CourseID'] ?>" data-name="<?php  echo  $row['CourseName'] ?>" data-type="<?php  echo  $row['CourseType'] ?>" data-price="<?php  echo  $row['CoursePrice'] ?>" data-image="<?php  echo  $row['Image'] ?>">Enroll</a>
