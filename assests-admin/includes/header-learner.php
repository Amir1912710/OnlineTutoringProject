...
<?php echo "<li class='nav-item'>Welcome, ".$_SESSION["FirstName"] ."</li>"; ?>
...
<!-- <img class="avatar" src="uploads/Amir.jpeg" alt="" /> -->
<?php echo "<img class='avatar' src=".$_SESSION["PersonalPhoto"]. " alt='' />"; ?>
