...
<?php  echo "<h2 class='text-danger mb-3'>".countLearners()."</h2>"; ?>
<h4 class="text-danger">All Learners</h4>
</div>		
</div>
	
<div class="col-md-4 mb-4">
<div class="card px-3 py-4 text-center">
<?php  echo "<h2 class='text-success mb-3'>".countCourses()."</h2>"; ?>
<h4 class="text-success">All Courses</h4>
</div>	
</div>
	
<div class="col-md-4 mb-4">
<div class="card px-3 py-4 text-center">
<?php  echo "<h2 class='text-warning mb-3'>".countAdmins()."</h2>"; ?>
